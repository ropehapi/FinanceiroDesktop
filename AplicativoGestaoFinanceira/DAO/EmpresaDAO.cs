...
namespace DAO
{
    public class EmpresaDAO
    {
        ...
        public List<tb_empresa> Read (int cod_logado)
        {
            banco objBanco = new banco();
            List<tb_empresa> lstEmpresas = objBanco.tb_empresa.Where(empr => empr.id_usuario == cod_logado).ToList();
            return lstEmpresas;
        }
        ...
        {
            banco objBanco = new banco();
            tb_empresa objResgate = objBanco.tb_empresa.Where(empr => empr.id_empresa == id_empresa).FirstOrDefault();
